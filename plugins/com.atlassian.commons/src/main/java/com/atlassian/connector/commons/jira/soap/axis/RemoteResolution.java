...
/*    */ {
/*    */   public RemoteResolution(String id, String name, String description, String icon) {
...
/* 30 */     if (!(obj instanceof RemoteResolution)) {
/* 31 */       return false;
/*    */     }
/* 33 */     (RemoteResolution)obj;
/* 34 */     if (obj == null) {
/* 35 */       return false;
/*    */     }
/* 37 */     if (this == obj) {
...
/*    */ 
/*    */   
/* 64 */   private static TypeDesc typeDesc = new TypeDesc(RemoteResolution.class, true);
/*    */   
/*    */   static {
/* 67 */     typeDesc.setXmlType(new QName("http://beans.soap.rpc.jira.atlassian.com", "RemoteResolution"));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              E:\cygwin64\tmp\com.atlassian.connector.commons_4.0.0.v20150427.jar!\com\atlassian\connector\commons\jira\soap\axis\RemoteResolution.class
