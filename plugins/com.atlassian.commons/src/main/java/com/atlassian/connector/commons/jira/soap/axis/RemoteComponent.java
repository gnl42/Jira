...
/* 26 */     if (!(obj instanceof RemoteComponent)) {
/* 27 */       return false;
/*    */     }
/* 29 */     (RemoteComponent)obj;
/* 30 */     if (obj == null) {
/* 31 */       return false;
/*    */     }
/* 33 */     if (this == obj) {
...
/*    */ 
/*    */   
/* 60 */   private static TypeDesc typeDesc = new TypeDesc(RemoteComponent.class, true);
/*    */   
/*    */   static {
/* 63 */     typeDesc.setXmlType(new QName("http://beans.soap.rpc.jira.atlassian.com", "RemoteComponent"));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              E:\cygwin64\tmp\com.atlassian.connector.commons_4.0.0.v20150427.jar!\com\atlassian\connector\commons\jira\soap\axis\RemoteComponent.class
