...
/* 18 */     if (!(obj instanceof RemoteAuthenticationException)) {
/* 19 */       return false;
/*    */     }
/* 21 */     (RemoteAuthenticationException)obj;
/* 22 */     if (obj == null) {
/* 23 */       return false;
/*    */     }
/* 25 */     if (this == obj) {
...
/*    */ 
/*    */   
/* 52 */   private static TypeDesc typeDesc = new TypeDesc(RemoteAuthenticationException.class, true);
/*    */   
/*    */   static {
/* 55 */     typeDesc.setXmlType(
/* 56 */         new QName("http://exception.rpc.jira.atlassian.com", "RemoteAuthenticationException"));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* Location:              E:\cygwin64\tmp\com.atlassian.connector.commons_4.0.0.v20150427.jar!\com\atlassian\connector\commons\jira\soap\axis\RemoteAuthenticationException.class
